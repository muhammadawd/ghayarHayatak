    ...
    export default {
        ...
        methods: {
            ...
            getDetails(id) {
                ...
                axios
                    .get(apiServiesRoutes.BASE_URL + apiServiesRoutes.FIND_COURSES + '/' + id, {
                        params: {
                            phone: localStorage.getItem('auth_mobile')
                        }
            ...
            PayKNET(video) {
                ...
                params.append('userID', auth_id);
                params.append('courseID', sub_course_duration_id);

                axios
                    .get(apiServiesRoutes.BASE_URL + apiServiesRoutes.PayKNET, {
                        params: {
                            mobile: phone,
                            userID: auth_id,
                            courseID: sub_course_duration_id
                        }
                    }).then((response) => {
